...
//                public void onSuccess(FirebaseUser user) {
//                    String userId = user.getUid();
//                    Log.d("SignUp", "Google Sign-In Success, userId: " + userId);
//                    sharedPreferences.edit()
//                            .putString("userId", userId)
//                            .putBoolean("isGuest", false)
//                            .apply();
...
//                @Override
//                public void onFailure(String errorMessage) {
//                    Log.e("SignUp", "Google Sign-In Failure: " + errorMessage);
//                    Toast.makeText(SignUp.this, errorMessage, Toast.LENGTH_SHORT).show();
//                }
//            });
//        }
...
public class SignUp extends AppCompatActivity {
    ...
    private void setupGoogleButton() {
        googleBtn.setOnClickListener(v -> firebaseHelper.signInWithGoogle(new AuthCallback() {
            @Override
            public void onSuccess(FirebaseUser user) {
                Log.d("SignUp", "signInWithGoogle Success, userId: " + user.getUid());
            }
            @Override
            public void onFailure(String errorMessage) {
                Log.e("SignUp", "signInWithGoogle Failure: " + errorMessage);
                Toast.makeText(SignUp.this, errorMessage, Toast.LENGTH_SHORT).show();
            }
        }));
    }
