...
public class HomeFragment extends Fragment implements IView, mealsAdapter.OnMealClickListener {
    ...
    private void setupRecyclerViews() {
        ...
        countryMealsAdapter = new mealsAdapter(getContext(), new ArrayList<>(), this);
        ...
        userCountryMealsAdapter = new mealsAdapter(getContext(), new ArrayList<>(), this);
    ...
    private void updateUserCountryTitle() {
        if (getActivity() != null) {
